...
import org.richfaces.component.UIInputNumber;
...
@JsfComponent(
        generate = "nf.co.fonk.richfaces.component.html.HtmlInputIntervalSlider",
        type = AbstractInputIntervalSlider.COMPONENT_TYPE,
        family = AbstractInputIntervalSlider.COMPONENT_FAMILY,
        renderer = @JsfRenderer(type = "nf.co.fonk.richfaces.component.InputIntervalSliderRenderer"),
        tag = @Tag(name = "inputIntervalSlider"))
public abstract class AbstractInputIntervalSlider extends UIInputNumber implements AccesskeyProps, CoreProps, EventsKeyProps, EventsMouseProps, FocusProps, I18nProps, InputProps {
    public static final String COMPONENT_TYPE = "nf.co.fonk.richfaces.component.InputIntervalSlider";
